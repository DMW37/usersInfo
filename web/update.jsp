...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/updateUserServlet?currentPage=${requestScope.currentPage}" method="post">
        <%--下面一行是叫做隐藏域--%>
        ...
        <div class="form-group">
            ...
            <c:if test="${requestScope.user.gender==''||requestScope.user.gender==null}">
                <input type="radio" name="gender" value="男"/>男
                <input type="radio" name="gender" value="女"/>女
            </c:if>
        ...
        <div class="form-group">
            ...
            <select name="address" class="form-control">
                ...
                <c:if test="${requestScope.user.address==null||requestScope.user.address==''}">
                    <option value="广东">广东</option>
                    <option value="广西">广西</option>
                    <option value="湖南">湖南</option>
                </c:if>
